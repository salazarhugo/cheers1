export const environment = {
    production: true,
    recaptchaSiteKey: '6Ld-nmohAAAAANqAnr7t0zuvSs71gtAhJlSgFlRl',
    firebaseConfig: {
    ...
    mapbox: {
        ...
        secretToken: 'sk.eyJ1Ijoic2FsYXphcmJyb2NrIiwiYSI6ImNsNzd3em5oZzA0M3MzcG8zYjBmeHYxM3UifQ.FVWMjFboIKIwWiFO7JN0lw'
    },
    stripe: {
