...
require (
	...
	github.com/salazarhugo/cheers1/genproto v0.0.0-20221016190848-56633ebdbae5
	...
	github.com/salazarhugo/cheers1/libs/utils v0.0.0-20221016133953-26cc3fd3af79
