...
func (c *userServiceClient) GetUserNode(ctx context.Context, in *GetUserNodeRequest, opts ...grpc.CallOption) (*GetUserNodeResponse, error) {
	out := new(GetUserNodeResponse)
	err := c.cc.Invoke(ctx, "/cheers.user.v1.UserService/GetUserNode", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) GetUserItemsIn(ctx context.Context, in *GetUserItemsInRequest, opts ...grpc.CallOption) (*GetUserItemsInResponse, error) {
	out := new(GetUserItemsInResponse)
	err := c.cc.Invoke(ctx, "/cheers.user.v1.UserService/GetUserItemsIn", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) CheckUsername(ctx context.Context, in *CheckUsernameRequest, opts ...grpc.CallOption) (*CheckUsernameResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cheers.user.v1.UserService/CheckUsername", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUserServiceServer) GetUserNode(context.Context, *GetUserNodeRequest) (*GetUserNodeResponse, error) {
...
func _UserService_GetUserNode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetUserNodeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).GetUserNode(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cheers.user.v1.UserService/GetUserNode",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetUserNode(ctx, req.(*GetUserNodeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _UserService_GetUserItemsIn_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetUserItemsInRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).GetUserItemsIn(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cheers.user.v1.UserService/GetUserItemsIn",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetUserItemsIn(ctx, req.(*GetUserItemsInRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _UserService_CheckUsername_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cheers.user.v1.UserService/CheckUsername",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _UserService_GetUserNode_Handler,
		},
		{
			MethodName: "GetUser",
		...
		},
		{
			...
			Handler:    _UserService_GetUserItemsIn_Handler,
		},
		{
