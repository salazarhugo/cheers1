...
func (x *LikePost) GetUser() *user.UserItem {
	if x != nil {
		return x.User
	}
	return nil
...
var file_cheers_post_v1_post_event_proto_rawDesc = []byte{
	...
	0x72, 0x22, 0x5c, 0x0a, 0x08, 0x4c, 0x69, 0x6b, 0x65, 0x50, 0x6f, 0x73, 0x74, 0x12, 0x25, 0x0a,
	...
	0x70, 0x6f, 0x73, 0x74, 0x12, 0x29, 0x0a, 0x04, 0x75, 0x73, 0x65, 0x72, 0x18, 0x02, 0x20, 0x01,
...
var file_cheers_post_v1_post_event_proto_depIdxs = []int32{
	...
	5, // 6: cheers.post.v1.LikePost.user:type_name -> cheers.type.UserItem
	5, // 7: cheers.post.v1.DeletePost.sender:type_name -> cheers.type.UserItem
