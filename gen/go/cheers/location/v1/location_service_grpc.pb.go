...
func (c *locationServiceClient) UpdateLocation(ctx context.Context, in *UpdateLocationRequest, opts ...grpc.CallOption) (*UpdateLocationResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cheers.location.v1.LocationService/UpdateLocation", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _LocationService_UpdateLocation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cheers.location.v1.LocationService/UpdateLocation",
	}
...
func _LocationService_ListFriendLocation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(LocationServiceServer).ListFriendLocation(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cheers.location.v1.LocationService/ListFriendLocation",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LocationServiceServer).ListFriendLocation(ctx, req.(*ListFriendLocationRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var LocationService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cheers.location.v1.LocationService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _LocationService_ListFriendLocation_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "cheers/location/v1/location_service.proto",
}
