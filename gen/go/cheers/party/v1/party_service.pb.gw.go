...
var (
	filter_PartyService_ListParty_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
func RegisterPartyServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server PartyServiceServer) error {
	...
	mux.Handle("GET", pattern_PartyService_ListParty_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/cheers.party.v1.PartyService/ListParty", runtime.WithHTTPPathPattern("/v1/parties/list"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterPartyServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client PartyServiceClient) error {
	...
	mux.Handle("GET", pattern_PartyService_ListParty_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/cheers.party.v1.PartyService/ListParty", runtime.WithHTTPPathPattern("/v1/parties/list"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	...
	pattern_PartyService_ListParty_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "parties", "list"}, ""))
