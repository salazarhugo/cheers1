...
var (
	filter_StoryService_FeedStory_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
func request_StoryService_FeedStory_0(ctx context.Context, marshaler runtime.Marshaler, client StoryServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_StoryService_FeedStory_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func RegisterStoryServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server StoryServiceServer) error {
	...
	mux.Handle("GET", pattern_StoryService_FeedStory_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/cheers.story.v1.StoryService/FeedStory", runtime.WithHTTPPathPattern("/v1/stories/feed"))
		if err != nil {
...
func RegisterStoryServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client StoryServiceClient) error {
	...
	mux.Handle("GET", pattern_StoryService_FeedStory_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/cheers.story.v1.StoryService/FeedStory", runtime.WithHTTPPathPattern("/v1/stories/feed"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_StoryService_FeedStory_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "stories", "feed"}, ""))
)
